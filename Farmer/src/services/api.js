...
export const sensorService = {
  getLiveData: async () => {
    const endpoints = [
      '/sensor/data',
      '/sensor',
      'http://10.114.42.241:5000/api/sensor/data', // Your current local IP
      'http://10.0.2.2:5000/api/sensor/data',      // Android Emulator loopback
      'http://localhost:5000/api/sensor/data'      // iOS Simulator / Web
    ];
